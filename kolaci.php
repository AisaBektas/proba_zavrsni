        ...
        <div id="carousel-example" class="carousel slide" data-ride="carousel">
            ...
            <?php 
                ...
                <div  class="carousel-item col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 <?php echo $actives; ?>">
					...
					<div class="card textcard font-italic color pt-4">
                   
                    	<img id="velicina_slika" class="img-fluid mx-auto d-block rounded-pill shadow" src="<?php echo $row['picture']?>" alt="cokotorta">
