...
<nav id="nav" class="navbar navbar-expand-sm fixed-top"><!--promijenila boju navbar koristeci navbar klasu-->
  ...
  <ul class="navbar-nav d-flex ml-auto"> <!--d-flex i ml-auto da se pomjere na desnu stranu, text-color,navbarcolor, logo i color ubacila svoj css  -->
    <li class="nav-item active">
      <a class="nav-link rounded-pill font-weight-bold" href="#" data-target="profilproba">Profil</a>
    </li>
    <li class="nav-item">
    <a class="nav-link rounded-pill font-weight-bold" href="#" data-target="prijavaadmina">Log out</a>
    </li>
  </ul>
			</div>  
</nav>
<!-- <nav id="nav">
<ul>
    <li><a href="#" data-target="index">index</a></li>
